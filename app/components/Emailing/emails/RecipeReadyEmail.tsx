...
export default function RecipeReadyEmail({
  unsubscribe_token,
  introText,
  generatedRecipe,
  recentRecipes,
          ...
          <div className='w-[650px] px-20 py-8 bg-white'>
            ...
            <div className='text-gray-800'>
              ...
              <div className='w-full mb-8'>
                <Img
                  src={`${s3Url}${generatedRecipe.meal_image}`}
                  alt={generatedRecipe.name}
                  className='w-full h-56 rounded-10 mb-5 object-cover'
                />
                <div>
                  <p className='text-base font-bold text-dark-primary text-center !m-0'>
                    {generatedRecipe.recipe_category}
                  </p>
                  <p className='text-3xl text-center lg:text-4xl font-bold !m-0'>
                ...
                <div className='w-full mt-2 flex justify-center items-center'>
                  <Link
                    href={`${baseUrl}/recipe/${generatedRecipe.query}`}
                    className='py-2 px-8 bg-primary text-white font-bold rounded-10 max-w-max whitespace-nowrap cursor-pointer no-underline mx-auto'
                  >
                    View The Recipe
                  </Link>
                </div>
